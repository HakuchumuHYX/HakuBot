...
from ..utils.common import download_image, get_group_id, extract_image_data

# 注册事件处理器
poke = on_notice()
contribute = on_command("投稿", rule=to_me(), priority=CONTRIBUTE_COMMAND_PRIORITY, block=True)
