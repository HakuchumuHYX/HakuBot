from plugins.group_daily_analysis.analysis.context import TranscriptContext, UserFeature
...
def _choose_title(feature: UserFeature) -> tuple[str, str]:
    ...
    if feature.night_message_count >= max(1, feature.message_count // 2):
        return (
            "夜猫子",
            f"深夜发言 {feature.night_message_count} 次，明显还在熬夜冲浪。",
        )
